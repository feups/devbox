...
4. optionally copy the https://github.com/CIRB/devbox/blob/master/user/params.sh[params file] in the root of this repository. Do not copy/paste from Github UI, download source (https://raw.githubusercontent.com/CIRB/devbox/master/user/params.sh) and edit to avoid unwanted characters.
