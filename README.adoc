...
You can use a semantic name #$subgroup.$role.$hostgroup.zone.cicd# as a `dns` to lookup any machine known by `puppetdb`.
...
```
For more specific cicd help, have a look at the following section:
